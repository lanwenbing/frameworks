      ...
      $('[data-plugin="jquery-selective"]').selective({
        ...
        tpl: {
          ...
          listItem: function(data) {
            return '<li class="' + this.namespace + '-list-item"><img class="avatar" src="../../../../../../classic/center/assets/examples/js/dashboard/' + data.avatar + '">' + data.name + '</li>';
          },
          item: function(data) {
            return '<li class="' + this.namespace + '-item"><img class="avatar" src="../../../../../../classic/center/assets/examples/js/dashboard/' + data.avatar + '" title="' + data.name + '">' +
